            const {
                ...
                SlashCommandBuilder, EmbedBuilder, PermissionFlagsBits, ActionRowBuilder, ButtonBuilder, ButtonStyle
            } = require("discord.js");
           ...
           module.exports = {
               structure: new SlashCommandBuilder()
                    .setName("level-announce")
                    .setDescription("setup announce message, channel or enable disable the announce message")
                        ...
                        if (i.customId === "toggle") {
                            ...
                            if (data.Announcements) {
                                ...
                                data.update({ Announcements: false }).then(async () => {
                                    ...
                                    const data1 = await Database.read(`${interaction.guildId}`);

           ...
           module.exports = {
               structure: new SlashCommandBuilder()
                    .setName("stats")
                    .setDescription("see the stats of the bot"),
               options: {
                    nsfw: false,
                    developers: false,
cooldown: 5000
                ...
                */
                run: async (client, interaction) => {
                    ...
                    interaction.reply({ content: "Wait For Some Time Fetching Data..."})
            ...
            await interaction.editReply({ embeds: [replyEmbed], files: [attachment], content: ""})
